...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-200 dark:bg-gray-950">
      <aside className="w-44 shrink-0 sticky top-0 h-screen bg-white dark:bg-gray-900 flex flex-col px-4 py-6 overflow-y-auto">
        <div className="mb-8 px-1">
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 leading-none">bb.</p>
        ...
        <div className="flex flex-col gap-0.5">
          <a
            href="/"
            className="flex items-center gap-2.5 px-3 py-2.5 text-[13px] text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-2.5 text-[13px] text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors cursor-pointer w-full text-left"
          >
            <LogOut size={16} />
            Log out
          </button>
